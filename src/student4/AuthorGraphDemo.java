...
public class AuthorGraphDemo {
    public static void main(String[] argd) {
        ...
        System.out.println("==============================================");
        System.out.println("=== DEMO AUTHOR GRAPH MODULE (vs code) ===");
        System.out.println("==============================================");

        while (running) {
            System.out.println("\n-- PILIH FITUR YANG WANT DICOBA--");
        ...
        while (running) {
            ...
            switch (input) {
                ...
                case "2":
                    ...
                    if (coAuthors.length == 0) {
                        System.out.println("Penulis tidak dapan ditemukan atau tidak memiliki teman kolaborasi.");
                    } else {
                        System.out.println("\nDirect Co-authors of " + name + ":");
                        for (String author : coAuthors) {
                            System.out.println("- " + author);
                ...
                case "5":
                    System.out.print("\nMasukkan nama penulis pertama: ");
                    String a1 = scanner.nextLine().trim();
                    System.out.print("Masukkan nama penulis keduda: ");
                    String a2 = scanner.nextLine().trim();
                    ...
                    if (linked) {
                        ...
                        System.out.println("Gagal! Pastikan kedau penulis sudah terdaftar dan belum terhubung.");
                    }
                    break;
